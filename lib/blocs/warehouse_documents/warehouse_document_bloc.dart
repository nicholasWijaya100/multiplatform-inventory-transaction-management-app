  ...
  Future<void> _onUpdateWarehouseDocumentStatus(
    ...
    try {
      ...
      if (event.status == WarehouseDocumentStatus.cancelled) {
        ...
        // Note: We don't automatically cancel sales orders when delivery notes are cancelled
        // This is a business decision - you may want to handle cancelled deliveries differently
      }
