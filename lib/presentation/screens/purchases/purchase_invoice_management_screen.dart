...
import '../../widgets/purchases/add_purchase_invoice_dialog.dart';
import '../../widgets/purchases/purchase_invoice_filters.dart';
import '../../widgets/purchases/purchase_invoice_list.dart';
import '../../widgets/purchases/purchase_invoice_stats_cards.dart';

class PurchaseInvoiceManagementScreen extends StatefulWidget {
  const PurchaseInvoiceManagementScreen({Key? key}) : super(key: key);

  @override
  State<PurchaseInvoiceManagementScreen> createState() =>
      _PurchaseInvoiceManagementScreenState();
}
                  ...
                  if (state is PurchaseInvoicesLoaded) {
                    ...
                    return PurchaseInvoiceList(
                      ...
                      onMarkAsPaid: (invoice) {
                        context.read<PurchaseInvoiceBloc>().add(
                          MarkPurchaseInvoiceAsPaid(invoice.id),
                        );
                      },
                    );
                  }
