...
class _EditSupplierDialogState extends State<EditSupplierDialog> {
  ...
  void initState() {
    ...
    _descriptionController = TextEditingController(text: widget.supplier.description);
  }
  ...
  void _handleSubmit() {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      context.read<SupplierBloc>().add(UpdateSupplier(updatedSupplier));
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                // Statistics Section
                if (widget.supplier.totalOrders > 0) ...[
                  const SizedBox(height: 24),
                  Container(
                        ...
                        Row(
                          children: [
                            Expanded(
                              child: _StatItem(
                                label: 'Total Orders',
                                value: widget.supplier.totalOrders.toString(),
                            ...
                            Expanded(
                              child: _StatItem(
                                label: 'Total Value',
                                value: Formatters.formatCurrency(widget.supplier.totalPurchases),
